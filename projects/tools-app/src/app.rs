...
use crate::components::parent_child::{
    ...
    parent_child_closure_instead_of_callback::Parent as ClosureInsteadOfCallback,
...
pub fn PageFooter() -> impl IntoView {
    view! {
        <footer id="page-footer">
            <p>"© 2021 Oplyst International, LLC"</p>
        </footer>
    }
}
            ...
            <Routes>
                ...
                <Route path="/parent-child" view=ParentChildHome>
                    <Route path="" view=|| view! {
                        <p> Click on an example outlet link </p>
                    }/>
                    <Route path="write-signal" view=ParentWriteSignal/>
                    <Route path="callback" view=ParentCallback/>
                    <Route path="closure-instead-of-callback" view=ClosureInsteadOfCallback/>
